...
The support vector machines in scikit-learn support both dense (numpy.ndarray and convertible to that by numpy.asarray)
 ...
 and sparse (any scipy.sparse) sample vectors as input. However, to use an SVM to make predictions for sparse data, it must have 
...
next_chain=template3|model|parser
final_chain=parallel_chain|next_chain
